...
{
    header('Location: https://'.$_SERVER['HTTP_HOST'].'/login.php?redirect=/error503.php'.(empty($_SERVER['QUERY_STRING']) ? "" : "&".$_SERVER['QUERY_STRING']), TRUE, 307);
    die();
}
?>
<!DOCTYPE html>
...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en-GB"> <!--<![endif]-->
	<head>
		...
		<title><?php echo (!empty($PAGETITLE) ? $PAGETITLE : "503 Service Unavailable"); ?></title>
		...
		<div id="error-container">
			...
			<div class="row">
				<div class="col-sm-8 col-sm-offset-2 text-center">
                    ...
                    <h2 class="h3">Oops, we are sorry but our service is currently not available.<br>Please try again later..</h2>
