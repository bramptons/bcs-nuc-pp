...
{
    header('Location: https://'.$_SERVER['HTTP_HOST'].'/login.php?redirect=/error500.php'.(empty($_SERVER['QUERY_STRING']) ? "" : "&".$_SERVER['QUERY_STRING']), TRUE, 307);
    die();
}
?>
<!DOCTYPE html>
...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en-GB"> <!--<![endif]-->
	<head>
		...
		<title><?php echo (!empty($PAGETITLE) ? $PAGETITLE : "500 Internal Server Error"); ?></title>
		...
		<div id="error-container">
			...
			<div class="row">
				<div class="col-sm-8 col-sm-offset-2 text-center">
                    ...
                    <h2 class="h3">Oops, we are sorry but our server encountered an internal error..<br>Please contact the system administrator.</h2>
