...
{
    header('Location: https://'.$_SERVER['HTTP_HOST'].'/login.php?redirect=/error403.php'.(empty($_SERVER['QUERY_STRING']) ? "" : "&".$_SERVER['QUERY_STRING']), TRUE, 307);
    die();
}
?>
<!DOCTYPE html>
...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en-GB"> <!--<![endif]-->
	<head>
		...
		<title><?php echo (!empty($PAGETITLE) ? $PAGETITLE : "403 Forbidden"); ?></title>
